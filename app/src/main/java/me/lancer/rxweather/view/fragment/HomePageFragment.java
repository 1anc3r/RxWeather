...
import me.lancer.rxweather.view.adapter.DetailAdapter;
import me.lancer.rxweather.view.adapter.ForecastAdapter;
...
public class HomePageFragment extends BaseFragment implements HomePageContract.View {
    ...
    private List<WeatherDetail> createDetails(Weather weather) {
        ...
        details.add(new WeatherDetail(R.drawable.ic_temperature, "体感温度", weather.getWeatherLive().getFeelsTemperature() + "°C"));
        details.add(new WeatherDetail(R.drawable.ic_humidity, "湿度", weather.getWeatherLive().getHumidity() + "%"));
        details.add(new WeatherDetail(R.drawable.ic_ultraviolet, "紫外线指数", weather.getWeatherForecasts().get(0).getUv()));
        details.add(new WeatherDetail(R.drawable.ic_rainfall, "降水量", weather.getWeatherLive().getRain() + "mm"));
        details.add(new WeatherDetail(R.drawable.ic_rainfall_probability, "降水概率", weather.getWeatherForecasts().get(0).getPop() + "%"));
        details.add(new WeatherDetail(R.drawable.ic_visibility, "能见度", weather.getWeatherForecasts().get(0).getVisibility() + "km"));
        return details;
    }
